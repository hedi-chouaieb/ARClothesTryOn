...
namespace ARClothesTryOn
{
    public class HolisticTrackingSolution : ImageSourceSolution<HolisticTrackingGraph>
    {
        ...
        protected override IEnumerator WaitForNextValue()
        {
            ...
            if (activateHolisticAnnotationController)
            ...
            if (activatePoseRoiAnnotationController)
        ...
        [SerializeField] bool activateHolisticAnnotationController;
        ...
        [SerializeField] bool activatePoseRoiAnnotationController;
